    ...
    <div className="space-y-4">
      ...
      {error && !isLoading && (
        <div className="text-center py-6 text-gray-500">
          ...
          <p className="text-sm">Status history unavailable</p>
        </div>
      )}
              ...
              {sortedHistory.map((entry, index) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline dot */}
                    <div
                      className={`absolute left-3 w-5 h-5 rounded-full border-2 ${toConfig.bgColor} ${toConfig.borderColor} flex items-center justify-center ${
                    ...
                    <div
                      className={`p-4 rounded-lg border ${
                        isLatest
                          ? `${toConfig.bgColor} border-l-4 ${toConfig.borderColor}`
                    ...
                    >
                        ...
                        {entry.fromStatus ? (
                          <>
                            <span className={`px-2 py-0.5 rounded text-xs font-medium ${fromConfig?.bgColor} ${fromConfig?.color}`}>
                              {fromConfig?.label || entry.fromStatus}
                            </span>
                      ...
                      <div className="mt-3 flex items-center gap-4 text-xs text-gray-500 flex-wrap">
                        <div className="flex items-center gap-1">
                          ...
                          <span>{entry.changedByAgentName || 'System'}</span>
                        </div>
                        <div className="flex items-center gap-1">
